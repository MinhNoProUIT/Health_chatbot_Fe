...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var id, cacheKey, cached, medicalInfo, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!id) {
                    return [2 /*return*/, (0, responseFormatter_1.formatErrorResponse)(400, "Missing medical info ID")];
                }
                cacheKey = "medical-info:".concat(id);
            ...
            case 1:
                ...
                return [4 /*yield*/, medicalInfoService.getById(id)];
            case 2:
                medicalInfo = _b.sent();
                if (!medicalInfo) {
                    return [2 /*return*/, (0, responseFormatter_1.formatErrorResponse)(404, "Medical information not found")];
                }
                return [4 /*yield*/, cacheService.set(cacheKey, medicalInfo, sources_config_1.cacheConfig.articleDetailsTTL)];
            case 3:
                _b.sent();
                return [2 /*return*/, (0, responseFormatter_1.formatSuccessResponse)({
                        data: medicalInfo,
...
//# sourceMappingURL=getMedicalInfo.js.map