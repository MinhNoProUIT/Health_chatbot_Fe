...
var CacheService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(result.Item.ttl < now)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.delete(key)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, null];
                    case 3: return [2 /*return*/, JSON.parse(result.Item.value)];
                    case 4:
                        error_1 = _a.sent();
    ...
    CacheService.prototype.generateCacheKey = function (prefix, params) {
        var sortedParams = Object.keys(params)
            .sort()
            .map(function (k) { return "".concat(k, ":").concat(params[k]); })
            .join("|");
        return "".concat(prefix, ":").concat(sortedParams);
    };
    return CacheService;
}());
